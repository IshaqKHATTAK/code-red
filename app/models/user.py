from sqlalchemy import Text, Column, Integer, String, Boolean, DateTime, ForeignKey, Index, Enum as SQLAEnum
...
class User(Base):
    ...
    supervisor_chatbot_ids = Column(ARRAY(Integer), nullable=True)
